...
class Decoder(layers.Layer, BiCoder):
        ...
        #  @decorator BiCoder._calculateXhatPosteriorDistribution transform data with equation used to get x from posterior distribution                    #  @param     data z (black and white images) from encoder
